...
{
	/**
	 * @var		string	The help screen key for the style.
	 * @since   1.6
	 */
	protected $helpKey = 'JHELP_EXTENSIONS_TEMPLATE_MANAGER_STYLES_EDIT';

	/**
	 * @var		string	The help screen base URL for the style.
	 * @since   1.6
	 */
	protected $helpURL;
	...
	*/
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onExtensionBeforeSave', array('com_advancedtemplates.style', &$table, $isNew));
		...
		$dispatcher->trigger('onExtensionAfterSave', array('com_advancedtemplates.style', &$table, $isNew));
