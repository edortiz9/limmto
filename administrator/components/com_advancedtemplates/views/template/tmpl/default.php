						...
						<li class="component-folder">
							...
							<ul class="nav nav-list">
								<?php foreach ($value as $view): ?>
									<li>
										<a class="component-file-url" href="<?php echo JRoute::_('index.php?option=com_advancedtemplates&view=template&task=template.overrides&folder=' . $view->path . '&id=' . $input->getInt('id') . '&file=' . $this->file); ?>">
...
<?php if ($this->type != 'home'): ?>
	<form action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.renameFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
		  method="post" >
...
<?php if ($this->type != 'home'): ?>
	<div  id="deleteModal" class="modal hide fade">
		...
		<div class="modal-footer">
			<a href="#" class="btn" data-dismiss="modal"><?php echo JText::_('COM_TEMPLATES_TEMPLATE_CLOSE'); ?></a>
			<a href="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.delete&id=' . $input->getInt('id') . '&file=' . $this->file); ?>" class="btn btn-danger"><?php echo JText::_('COM_TEMPLATES_BUTTON_DELETE');?></a>
		</div>
	</div>
<?php endif; ?>
...
<div  id="fileModal" class="modal hide fade">
	...
	<div class="modal-body">
		...
		<div class="column">
			<form method="post" action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.createFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
				class="well" >
				<fieldset>
			...
			<form method="post" action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.uploadFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
			...
			<?php if ($this->type != 'home'): ?>
				<form method="post" action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.copyFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
					  class="well" enctype="multipart/form-data" >
					<fieldset>
						<input type="hidden" class="address" name="address" />
						<div class="control-group">
...
<div  id="folderModal" class="modal hide fade">
	...
	<div class="modal-body">
		...
		<div class="column">
			<form method="post" action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.createFolder&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
				  class="well" >
				<fieldset>
...
<?php if ($this->type != 'home'): ?>
	<form action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.resizeImage&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
		  method="post" >
